...
if page == pages[1]:
    ...
    st.write("<div class='customInnerFont'>The World Happiness Report (WHR) is a partnership programme of Gallup, "
             ...
             "freedom to make life choices, generosity and perception of corruption. As well as to understand how this "
             "variables are correlated to each other to influence the the happiness ladder score and consequentially "
             "contribute to the happiness of the people in there countries. <br><br>I will analyse and present the "
             "data using analytical interactive visualizations to determine the combinations of factors that explains "
             "why some countries are ranked to be happier than others. I will merge the available dataset of the "
             "world happiness report from 2005 till 2020 and 2021 as my base dataset and apply various machine learning methods "
             " to train and make predictions on the trained models with a sample data from this base dataset. To validate or invalidate "
